  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="gap-2 px-8 bg-white text-purple-700 font-bold hover:bg-slate-200 hover:text-black  tracking-wider" disabled={label === 'Connecting...'} onClick={() => setVisible(true)}>
